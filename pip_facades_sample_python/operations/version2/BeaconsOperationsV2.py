...
class BeaconsOperationsV2(RestOperations):

    def __init__(self):
        super(BeaconsOperationsV2, self).__init__()
    ...
    def get_beacons_x(self, site_id) -> Optional[str]:
    ...
    def get_beacon_x(self, site_id, beacon_id) -> Optional[str]:
    ...
    def update_beacon_x(self, site_id, beacon_id) -> Optional[str]:
    ...
    def delete_beacon_x(self, site_id, beacon_id) -> Optional[str]:
